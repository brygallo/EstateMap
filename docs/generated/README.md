...
| properties | `specs/domains/properties.yaml` | 30 | [properties.md](./properties.md) |
| publication-resume | `specs/domains/publication-resume.yaml` | 9 | [publication-resume.md](./publication-resume.md) |
| social-kit | `specs/domains/social-kit.yaml` | 12 | [social-kit.md](./social-kit.md) |
...
| matrix | `specs/permissions/matrix.yaml` | 70 | [matrix.md](./matrix.md) |
