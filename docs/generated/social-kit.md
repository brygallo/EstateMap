...
- `backend/real_estate/views.py:908-910` (`by_code`) — Resolución pública, sin distinguir mayúsculas y excluyendo inactivas.
...
- `backend/real_estate/views.py:722-732` (`def promotion_stats`)
