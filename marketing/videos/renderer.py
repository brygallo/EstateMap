...
SIMULATIONS = {
    ...
    "sim:credicasa-suite": "Una suite ilustrada de una habitación cruza las mismas condiciones de vivienda elegible",
    "sim:credicasa-age-term": "La edad y el plazo se detienen ante la esperanza de vida oficial aplicable, sin inventar una edad universal",
    ...
    "sim:credicasa-insurance-costs": "Seguro de desgravamen y seguro del inmueble entran como componentes adicionales del costo",
    "sim:credicasa-process-costs": "Avalúo, legales, notaría y registro se separan de la simulación inicial de capacidad",
    "sim:credicasa-expense-request": "Los gastos entran a petición y quedan limitados por avalúo y tope del producto",
    "sim:credicasa-ended-process": "Desistimiento, anulación, caducidad o rechazo convergen en posibles cobros, mora y bloqueo",
    ...
    "sim:credicasa-reservation-checks": "Antes de reservar se valida persona e inmueble; después se revisan devolución, gravámenes, registro y promesa con asesoría",
    ...
    "sim:credicasa-budget-map": "El presupuesto máximo filtra propiedades ilustrativas por precio dentro de las manzanas del mapa",
    "sim:credicasa-recap": "Recapitulación de tasa, financiamiento, tope con gastos y precalificación antes del cierre",
