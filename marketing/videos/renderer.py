...
SIMULATIONS = {
    "sim:que-compras": "Un departamento se enciende dentro del edificio y después se enciende el edificio entero, con sus reglas, sus vecinos y sus deudas",
    "sim:propiedad-horizontal": "La lista de lo que consta en la escritura: el departamento sí, el parqueadero y la bodega con signo de interrogación, y las áreas comunes",
    "sim:alicuota": "Los meses de alícuota pagados, lo que cubre, y el certificado firmado de que el vendedor está al día",
    "sim:edificio": "El acta de asamblea con su derrama aprobada, y después el recorrido por el ascensor, la bomba, la cisterna y las humedades",
