...
| --------- | ------------------------------------------- | ---------- | ----------- | ----------- |
| geo-001 | ¿Comprarías una casa sin saber dónde queda? | Terminado  | Publicado   | Publicado   |
| geo-002 | Deja de buscar propiedades a ciegas         | Terminado  | Publicado   | Publicado   |
| geo-003 | Publica tu propiedad por $0                 | Terminado  | Publicado   | Publicado   |
| geo-005 | Tres cosas que revisar antes de contactar   | Terminado  | Publicado   | Publicado   |
| geo-006 | Cómo nació Geo Propiedades Ecuador          | Terminado  | Publicado   | Publicado   |
| geo-008 | Catorce mil ya están en el mapa. La tuya no | Terminado  | Publicado   | **Pendiente** |
| geo-009 | Antes de ir a ver un terreno, revisa la ficha | Terminado | Publicado   | Publicado   |
| geo-007 | Esta web la hizo Aents                      | Terminado  | Publicado   | Publicado   |
...
- **Portada**: personalizada (`exports/geo-001-cover.png`), subida a mano en ambas redes.
...
- **Firmado por**: bryan, 13 ago 2026
- **Portada**: personalizada (`exports/geo-002-cover.png`), acento violeta, subida a mano en ambas redes.
...
- **Firmado por**: bryan, 13 ago 2026
- **Portada**: personalizada (`exports/geo-003-cover.png`), acento verde, subida a mano en ambas redes.
- **Descripción publicada** (idéntica a `caption.txt`, sin añadidos):
...
- **Firmado por**: bryan, 13 ago 2026
- **Portada**: personalizada (`exports/geo-004-cover.png`), subida a mano.
