...
heredaba de la pieza de terrenos (geo-009) su portada y tres de sus siete
...
- **`sim:gravamenes-departamento`:** el sujeto pasa a ser una prop cuyo valor por
  defecto reproduce el texto que el geo-009 firmó, así que su máster no cambia.
