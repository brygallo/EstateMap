# Dirección de producción — geo-010
...
- **Para el máster final** hacen falta, en este orden:
  ...
  3. `video voice-cost geo-010` y autorización explícita del gasto.
  4. `video render geo-010 --final`, que escribirá `voice-lock.json` (hoy no existe en
     `library/geo-010/`) y fijará perfil y ajustes para siempre.
...
|---|---|---|
| 17:34:03 | `video lint` pasa | `library/geo-010/lint.json:7` |
| 17:34:27 | se lanza `./video render geo-010` | transcripción de sesión `73f76f66-8efe-4b7c-a746-c7ba7cf63b90.jsonl`, `2026-08-14T22:34:27Z` |
| 17:42:57 | se escribe `exports/geo-010.mp4` | `mtime` del archivo |
| 17:43:03 | se escribe `production.json` | `production.json:2` (`rendered_at`) |
| 17:46:59 | `video review` pasa | `library/geo-010/review.json:2` |
...
**Acción:** volver a renderizar con `./video render geo-010` (borrador, Kokoro, sin
...
`exports/geo-010-cover.png` (inspeccionada): «Antes de comprar un departamento» se parte en cuatro
