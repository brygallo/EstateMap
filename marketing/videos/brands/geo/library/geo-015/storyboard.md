...
- Rótulo: Uno por uno
- Voz: Llevas rato abriendo anuncios y todavía no sabes cuál es el más barato.
- Subtítulos: Llevas rato abriendo anuncios / y todavía no sabes cuál es / el más barato.
- Entrada: cut
...
- Rótulo: Respira
- Voz: Respira. Esa lista ya está hecha.
- Subtítulos: Respira. Esa lista ya está hecha.
- Entrada: cut
...
- Rótulo: Cambia la pregunta
- Voz: Los terrenos más baratos de tu ciudad. O los más grandes. Tú eliges.
- Subtítulos: Los terrenos más baratos de / tu ciudad. / O los más grandes. / Tú eliges.
- Entrada: cut
...
- Recurso: sim:recetas-ranking
- Rótulo: Se arma sola
- Voz: Y no la escribió nadie: se arma con lo que hay publicado hoy.
- Subtítulos: Y no la escribió nadie: / se arma con lo que hay / publicado hoy.
- Entrada: cut
...
- Voz: Cada terreno te dice por qué está ahí y en qué parte del mapa queda.
- Subtítulos: Cada terreno te dice por qué / está ahí y en qué parte / del mapa queda.
- Entrada: cut
...
- Rótulo: El primer puesto
- Voz: Y lo mejor: ese primer puesto no se compra. Ni con publicidad, ni con clics.
- Subtítulos: Y lo mejor: / ese primer puesto no se compra. / Ni con publicidad, / ni con clics.
- Entrada: cut
...
- Voz: Solo con el precio. Encuentra el tuyo en geopropiedadesecuador punto com.
- Subtítulos: Solo con el precio. / Encuentra el tuyo / en geopropiedadesecuador punto com.
- Entrada: fade
