...
SIMULATIONS = {
    ...
    "sim:credicasa-suite": "educación Credicasa: una suite de una habitación cruza las condiciones de vivienda",
    "sim:credicasa-age-term": "educación Credicasa: edad, plazo y esperanza de vida oficial aplicable",
    "sim:credicasa-payment-example": "ejemplo Credicasa: cuota aproximada, seguros, gastos y simulación oficial",
    "sim:credicasa-insurance-costs": "educación Credicasa: seguro de desgravamen y seguro del inmueble",
    "sim:credicasa-process-costs": "educación Credicasa: gastos del proceso que no aparecen en la simulación inicial",
    "sim:credicasa-expense-request": "educación Credicasa: petición de financiar gastos bajo dos límites",
    "sim:credicasa-ended-process": "educación Credicasa: cobros y consecuencias si el trámite termina sin préstamo",
    ...
    "sim:credicasa-reservation-checks": "educación Credicasa: validaciones y checklist legal antes de entregar una reserva",
    ...
    "sim:credicasa-budget-map": "resultado Geo: el presupuesto real filtra propiedades ilustrativas en el mapa",
    "sim:credicasa-recap": "recapitulación Credicasa antes del CTA final",
