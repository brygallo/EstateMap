...
export const SIMULATIONS: Record<string, React.FC<SimulationProps>> = {
  ...
  'sim:credicasa-age-term': CredicasaAgeTermSim,
  'sim:credicasa-suite': CredicasaSuiteSim,
  'sim:credicasa-payment-example': CredicasaPaymentExampleSim,
  'sim:credicasa-insurance-costs': CredicasaInsuranceCostsSim,
  'sim:credicasa-process-costs': CredicasaProcessCostsSim,
  'sim:credicasa-expense-request': CredicasaExpenseRequestSim,
  'sim:credicasa-ended-process': CredicasaEndedProcessSim,
  ...
  'sim:credicasa-reservation-checks': CredicasaReservationSim,
  'sim:credicasa-order-a': CredicasaOrderASim,
  'sim:credicasa-order-b': CredicasaOrderBSim,
  'sim:credicasa-budget-map': CredicasaBudgetMapSim,
  'sim:credicasa-recap': CredicasaRecapSim,
