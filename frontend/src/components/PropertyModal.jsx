              ...
              {property.contact_phone && (
                <div className="bg-gradient-to-r from-primary to-secondary p-2.5 rounded text-white">
                  ...
                  <a
                    ...
                    className="flex items-center gap-2 bg-white/20 hover:bg-white/30 transition-all p-2 rounded"
                  >
                    ...
                    <div>
                      <div className="text-[9px] opacity-90">Llamar / WhatsApp</div>
                      <div className="text-sm font-bold">{property.contact_phone}</div>
                    </div>
                  </a>
                </div>
              )}
